...
- **Horizontal rod holes go through `lib/bores.scad` (teardrop)** and parts are modeled in their print orientation — a plain horizontal cylinder bore is a finding. Exception: the hub shell's arm seats and the hub clamshell variant's grooves and bolt bores are plain rounds, because both print their open faces up (seats and channels open upward, bolt bores vertical).
